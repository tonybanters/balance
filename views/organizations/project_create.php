<?php $title = 'New Project - ' . h($organization['name']) . ' - Balance'; ?>
<?php ob_start(); ?>
...
<main class="content">
    ...
    <form method="POST" action="/o/<?= h($organization['slug']) ?>/projects/create" class="form">
        <label>
            Name
        ...
        <div class="form_actions">
            <a href="/o/<?= h($organization['slug']) ?>" class="btn">Cancel</a>
